...
export const posts: Post[] = [
  {
    ...
    date: "May 23, 2025",
    cover: A("jguNtVYh32U9SeTpRzxXyIOhqRI.jpg"),
    body: [
  ...
  },
  {
    ...
    date: "May 23, 2025",
    cover: A("RnspdH5WSIpfq7Qyu2EJdxWXw.jpg"),
    body: [
      ...
      "Visuals grab attention and leave an immediate impression, but without a solid strategy behind them, even the most stunning designs can fall flat. Great design isn’t just about looking good — it’s about working well, telling the right story, and achieving a purpose.",
  ...
  },
  {
    ...
    date: "May 23, 2025",
    cover: A("UhttJHgYv5v9K5nOB1SgfoSJNaE.jpg"),
    body: [
      "A signature visual language is what makes a brand instantly recognizable — long before anyone reads a single word. It’s the shorthand your audience uses to feel something the moment they see you.",
      "Colors, type, shape, and motion all work together to create a system that’s unmistakably yours. When those elements are consistent and intentional, recognition compounds: every touchpoint reinforces the last, and trust grows with each interaction.",
      "The goal isn’t to follow trends, but to build a language flexible enough to evolve and distinct enough to own. That balance — consistency with room to grow — is what separates brands that last from brands that blend in.",
    ],
  },
  {
    ...
    date: "May 23, 2025",
    cover: A("UxBFsKMzfFpYnsCxgkN3iUc.jpg"),
    body: [
      "Constraints aren’t the enemy of creativity — they’re often its greatest catalyst. A tight brief, a small palette, or a strict grid can push you toward ideas you’d never reach with infinite options.",
      "When everything is possible, nothing feels urgent. But give a team a clear boundary, and suddenly every decision matters. Limitations force focus, and focus is where great work begins.",
      "The best designers learn to love their constraints — to treat them as a frame rather than a cage. Within that frame, the truly inventive solutions appear.",
    ],
  },
  {
    ...
    date: "May 16, 2025",
    cover: A("vwKprytyeP5HhBmRSTrVvcLDIQ.jpg"),
    body: [
      "Before the first pixel, before the first sketch, comes the question that shapes everything: why does this exist? Strategy is the soil every great brand grows from.",
      "Plant with intention and the rest follows naturally — the palette, the voice, the layout all become expressions of a clear idea rather than decoration for its own sake.",
      "Aesthetics fade with the seasons. Intention is what keeps a brand rooted, recognizable, and resilient over time.",
    ],
  },
  {
    ...
    date: "May 17, 2025",
    cover: A("wC3yZuiJfempkYMiAwDYliyoldg.jpg"),
    body: [
      "Some of the most memorable work comes from the detours — the spontaneous decision, the happy accident, the constraint that forced a smarter solution.",
      "We build process and structure not to eliminate surprise, but to make room for it. The best ideas rarely arrive on schedule; they show up when curiosity is given a little space to wander.",
      "Stay open, stay adaptable, and trust that the unplanned moments are often where the real magic happens.",
    ],
  },
];
